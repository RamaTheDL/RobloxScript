...
local StrName = tostring(getgenv().StratName)
...
local writestrat = function(...)
    ...
    task.spawn(function()
        ...
        print(Text)
        return WriteFile(true,StrName,"StrategiesX/TDS/Recorder",tostring(Text).."\n")
    end)
end
local appendstrat = function(...)
    ...
    task.spawn(function()
        ...
        local Text = table.concat(TableText, " ")
        print(Text)
        return AppendFile(true,StrName,"StrategiesX/TDS/Recorder",tostring(Text).."\n")
    end)
end
getgenv().Recorder = {
    Troops = {
