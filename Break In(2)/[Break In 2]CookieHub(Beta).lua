...
if game.PlaceId ~= 13864667823 then
		...
		Callback = function()
			if LocalPlayer.PlayerGui:FindFirstChild("Respawn") then
				if LocalPlayer.PlayerGui:FindFirstChild("Respawn").Enabled == false then
					...
					loadstring(game:HttpGet('https://raw.githubusercontent.com/Nivgab/Lua-Projects/main/Protected_1918983247771990.lua.txt', true))()
				end
			else
				Notify('Info', "only works if you die(Respawn you from death)", 'rbxassetid://7733911828', 7)
			end
	...
	Tab:AddButton({
		Name = "Easy Mode",
		Callback = function()
			loadstring(game:HttpGet('https://raw.githubusercontent.com/Nivgab/Lua-Projects/main/obf_r6v12sxZLCDi5b7h2cut31l6GtnA92sU399DKOJyjotnm58GBQA67ol8d44q0r77.lua.txt', true))()
		end    
	})
	local Section = Tab:AddSection({
		Name = "Others"
